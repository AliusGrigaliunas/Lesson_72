...

{
  ...
  class Student extends Person {
    ...
    public getAvg() {
      ...
      ) => (currentValue + previousValue)) / this.marks.length;
    }
  }
  ...
  class Lecturer extends Person {
    ...
    set salary(value:number) {
      if (value < Lecturer.MIN_SALARY) throw new Error('Atlyginimas per žemeas');
      if (value > Lecturer.MAX_SALARY) throw new Error('Atlyginimas per didelis');
